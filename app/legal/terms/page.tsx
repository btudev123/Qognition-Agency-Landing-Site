      ...
      <main className="min-h-screen pt-36 pb-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose-custom space-y-8 text-[var(--text-muted)] leading-relaxed">
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">1. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">2. Services</h2>
              ...
              <p className="mt-4">Free audits and tools provided on our website are for informational purposes and do not constitute a professional engagement or guarantee specific results.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">3. Intellectual Property</h2>
              ...
              <p className="mt-4">Upon full payment for services, clients own the deliverables specified in their SOW. Qognition retains ownership of pre-existing tools, frameworks, methodologies, and reusable components used in delivery.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">4. Payment Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">5. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">6. Confidentiality</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">7. Termination</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">8. Governing Law</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">9. Changes to Terms</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-[var(--text)] mb-4">10. Contact</h2>
