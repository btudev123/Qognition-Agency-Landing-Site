      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="text-center py-24 border-t border-[var(--border)]">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mb-12">
            <a href="https://cal.com/hello-qognitionagency/30min" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-[var(--accent)] text-[var(--accent-deep)] font-medium px-8 py-4 text-sm hover:brightness-110 transition-all">Book Strategy Call</a>
